...
INSERT INTO answers (course_id, question_id, title, answer_content) VALUES (1, 1, 'My first answer', 'This is the content of the answer from database');
INSERT INTO answers (course_id, question_id, title, answer_content) VALUES (1, 1, 'My second answer', 'This is the content of the answer from database');
INSERT INTO answers (course_id, question_id, title, answer_content) VALUES (1, 2, 'My first answer', 'This is the content of the answer from database');
INSERT INTO answers (course_id, question_id, title, answer_content) VALUES (1, 2, 'My second answer', 'This is the content of the answer from database');
